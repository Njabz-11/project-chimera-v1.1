...
class Settings:
    ...
    def __init__(self):
        ...
        # Database Configuration (Genesis compliance - PostgreSQL by default)
        self.database_url = os.getenv("DATABASE_URL", "postgresql://chimera:chimera_password@localhost:5432/chimera_db")
